  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Phase" do
        expect {
          post :create, params: {phase: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {phase: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested phase" do
        phase = Phase.create! valid_attributes
        put :update, params: {id: phase.to_param, phase: new_attributes}, session: valid_session
        phase.reload
      ...
      it "redirects to the phase" do
        phase = Phase.create! valid_attributes
        put :update, params: {id: phase.to_param, phase: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        phase = Phase.create! valid_attributes
        put :update, params: {id: phase.to_param, phase: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
