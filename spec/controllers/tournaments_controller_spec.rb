...
RSpec.describe TournamentsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      tournament = Tournament.create! valid_attributes
      get :show, params: {id: tournament.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested tournament" do
        tournament = Tournament.create! valid_attributes
        put :update, params: {id: tournament.to_param, tournament: new_attributes}, session: valid_session
        tournament.reload
      ...
      it "redirects to the tournament" do
        tournament = Tournament.create! valid_attributes
        put :update, params: {id: tournament.to_param, tournament: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        tournament = Tournament.create! valid_attributes
        put :update, params: {id: tournament.to_param, tournament: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
